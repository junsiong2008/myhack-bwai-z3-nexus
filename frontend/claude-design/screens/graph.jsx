// Relationship Graph screen — radial layout with hover tooltips
const GraphScreen = ({ ecosystem }) => {
  ...
  const { nodes, edges } = React.useMemo(() => {
    ...
    // Companies positioned around their mentor
    ...
    companyList.forEach(c => {
      ...
      edges.push({ from: mid, to: c.id, kind: "approved", score, company: c.name, mentor: m.name, outcome: c.status });
    });
    ...
    <div>
      <div className="nx-card p-6">
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="text-[11px] mono px-2 py-1 rounded" style={{ background: "#EAF2FB", color: "#185FA5" }}>● Force-directed</div>
        </div>
        ...
        {/* Legend */}
        <div className="mt-2 pt-4 border-t flex flex-wrap items-center gap-5" style={{ borderColor: "#ECEAE3" }}>
