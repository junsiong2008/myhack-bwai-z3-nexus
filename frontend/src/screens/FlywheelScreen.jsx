    ...
    <div className="max-w-[1080px] mx-auto">
      <div className="text-center mb-8">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full mb-3 text-[11px] font-medium uppercase tracking-wide"
             style={{ background: "var(--nx-primary-50)", color: "#185FA5" }}>
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        <div className="nx-card p-6" style={{ background: "var(--nx-danger-50)", borderColor: "rgba(226,75,74,0.3)" }}>
          ...
          <ul className="space-y-3">
            {[
              ...
              <li key={i} className="flex gap-2.5 text-[13.5px]" style={{ color: "var(--nx-text)" }}>
        ...
        <div className="nx-card p-6" style={{ background: "var(--nx-success-50)", borderColor: "rgba(29,158,117,0.3)" }}>
      ...
      <div className="nx-card p-6 mb-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <button className="nx-btn-outline text-[12px] flex items-center gap-1.5" style={{ width: "auto" }}>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="rounded-lg border p-4" style={{ borderColor: "var(--nx-border-soft)", background: "var(--nx-card-subtle)" }}>
            ...
            <ul className="space-y-2 text-[12.5px]" style={{ color: "var(--nx-text)" }}>
      ...
      <div className="rounded-xl border-l-4 p-5 italic text-[15px] leading-relaxed"
           style={{ background: "var(--nx-primary-50)", borderLeftColor: "#185FA5", color: "var(--nx-text)", borderTop: "1px solid var(--nx-border-soft)", borderRight: "1px solid var(--nx-border-soft)", borderBottom: "1px solid var(--nx-border-soft)" }}>
